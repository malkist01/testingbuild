...
readonly DEFCONFIG="vendor/samsung/sm7125_defconfig"
...
curl -LSs "https://raw.githubusercontent.com/MrShockWAVEog/KernelSU-Next/refs/heads/shockwave/kernel/setup.sh" | bash -s shockwave
...
KERNEL_CODENAME=${KERNEL_CODENAME:-"a72"}
